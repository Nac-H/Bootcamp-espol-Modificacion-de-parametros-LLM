...
export const EnvironmentSchema = z.object({
  ...
  // OpenAI (will be used in branch 2/openai-sdk)
...
export const AppConfigSchema = z.object({
  ...
  openAI: OpenAIConfigSchema.optional(), // Will be required in branch 2/openai-sdk
});
...
export const createConfigFromEnv = (): AppConfig => {
  ...
  const config: AppConfig = {
    ...
    // OpenAI config will be added in branch 2/openai-sdk
    // openAI: env.SERVER_OPENAI_API_KEY ? {
    //   apiKey: env.SERVER_OPENAI_API_KEY,
    //   model: env.SERVER_OPENAI_MODEL || 'gpt-3.5-turbo',
    //   baseURL: env.SERVER_OPENAI_BASE_URL || 'https://api.openai.com/v1',
    //   timeout: env.SERVER_OPENAI_TIMEOUT || 60000,
